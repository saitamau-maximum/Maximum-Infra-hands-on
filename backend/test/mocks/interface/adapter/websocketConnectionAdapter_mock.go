...
// Source: /home/nakamura/program/Maximum/infra/Maximum-Infra-hands-on/backend/internal/interface/adapter/websocketConnectionAdapter.go
//
// Generated by this command:
//
//	mockgen -source=/home/nakamura/program/Maximum/infra/Maximum-Infra-hands-on/backend/internal/interface/adapter/websocketConnectionAdapter.go -destination=test/mocks/interface/adapter/websocketConnectionAdapter_mock.go
//
...
func (m *MockConnAdapter) ReadJSON(arg0 *entity.Message) error {
	m.ctrl.T.Helper()
...
func (mr *MockConnAdapterMockRecorder) ReadJSON(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadJSON", reflect.TypeOf((*MockConnAdapter)(nil).ReadJSON), arg0)
}
...
func (m *MockConnAdapter) WriteJSON(arg0 *entity.Message) error {
	m.ctrl.T.Helper()
...
func (mr *MockConnAdapterMockRecorder) WriteJSON(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteJSON", reflect.TypeOf((*MockConnAdapter)(nil).WriteJSON), arg0)
}
