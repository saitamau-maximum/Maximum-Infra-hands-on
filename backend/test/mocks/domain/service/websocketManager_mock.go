...
// Source: /home/nakamuraitsuki/program/Maximum/Infra/Maximum-Infra-hands-on/backend/internal/domain/service/websocketManager.go
//
// Generated by this command:
//
//	mockgen -source=/home/nakamuraitsuki/program/Maximum/Infra/Maximum-Infra-hands-on/backend/internal/domain/service/websocketManager.go -destination=test/mocks/domain/service/websocketManager_mock.go
//
...
func (m *MockWebsocketManager) GetConnectionByUserID(userID entity.UserID) (service.WebSocketConnection, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConnectionByUserID", userID)
...
func (mr *MockWebsocketManagerMockRecorder) GetConnectionByUserID(userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetConnectionByUserID", reflect.TypeOf((*MockWebsocketManager)(nil).GetConnectionByUserID), userID)
}
