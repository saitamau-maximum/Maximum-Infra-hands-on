...
//
//	mockgen --source=/home/nakamuraitsuki/program/Maximum/Infra/Maximum-Infra-hands-on/backend/internal/domain/repository/user_repository.go --destination=./domain/repository/user_repository_mock.go
//
