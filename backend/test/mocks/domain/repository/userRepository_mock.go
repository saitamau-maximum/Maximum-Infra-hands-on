...
// Source: /home/nakamuraitsuki/program/Maximum/Infra/Maximum-Infra-hands-on/backend/internal/domain/repository/userRepository.go
//
// Generated by this command:
//
//	mockgen -source=/home/nakamuraitsuki/program/Maximum/Infra/Maximum-Infra-hands-on/backend/internal/domain/repository/userRepository.go -destination=test/mocks/domain/repository/userRepository_mock.go
//
...
// GetIDByPublicID mocks base method.
func (m *MockUserRepository) GetIDByPublicID(publicID entity.UserPublicID) (entity.UserID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIDByPublicID", publicID)
	ret0, _ := ret[0].(entity.UserID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetIDByPublicID indicates an expected call of GetIDByPublicID.
func (mr *MockUserRepositoryMockRecorder) GetIDByPublicID(publicID any) *gomock.Call {
