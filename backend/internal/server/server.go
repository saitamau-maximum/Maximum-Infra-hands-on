...
import (
	...
	"example.com/webrtc-practice/internal/server/di"
	"example.com/webrtc-practice/internal/server/middleware"
	"example.com/webrtc-practice/internal/server/routes"
