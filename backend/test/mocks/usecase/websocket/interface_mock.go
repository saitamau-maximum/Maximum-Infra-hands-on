...
// Source: /home/nakamuraitsuki/program/Maximum/Infra/Maximum-Infra-hands-on/backend/internal/usecase/websocket/interface.go
//
// Generated by this command:
//
//	mockgen -source=/home/nakamuraitsuki/program/Maximum/Infra/Maximum-Infra-hands-on/backend/internal/usecase/websocket/interface.go -destination=test/mocks/usecase/websocket/interface_mock.go
//
...
import (
	...
	websocket "example.com/infrahandson/internal/usecase/websocket"
...
func (m *MockWebsocketUseCaseInterface) ConnectUserToRoom(ctx context.Context, req websocket.ConnectUserToRoomRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockWebsocketUseCaseInterface) DisconnectUser(ctx context.Context, req websocket.DisconnectUserRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockWebsocketUseCaseInterface) SendMessage(ctx context.Context, req websocket.SendMessageRequest) error {
	m.ctrl.T.Helper()
